...
WarmaneFixes.Update = function(event) {
    ...
    switch (WarmaneFixes.URL.SubDomain) {
        case '':
        case 'www':
            WarmaneFixes.UpdateIndex(event);
            break;

        case 'forum':
            WarmaneFixes.UpdateForum(event);
            break;

        case 'armory':
            WarmaneFixes.UpdateArmory(event);
            break;
    }
}

WarmaneFixes.UpdateIndex = function(event) {

}

WarmaneFixes.UpdateArmory = function(event) {
    ...
    if (query != null) {
        switch (query[1]) {
            case 'guild':
                WarmaneFixes.UpdateArmoryGuild(event, query[2], query[3], query[4]);
                break;

            case 'character':
                WarmaneFixes.UpdateArmoryCharacter(event, query[2], query[3], query[4]);
                break;
        }
    }
}

WarmaneFixes.UpdateArmoryGuild = function(event, name, realm, type) {
    switch (type) {
        case 'summary':
            WarmaneFixes.UpdateArmoryGuildSummary(event, name, realm);
            break;

        case 'boss-fights':
            WarmaneFixes.UpdateArmoryGuildBossFights(event, name, realm);
            break;
    }
}

WarmaneFixes.UpdateArmoryGuildSummary = function (event, name, realm) {
    if (event === 'ready') {
...
WarmaneFixes.UpdateArmoryGuildBossFights = function (event, name, realm) {
    if (event === 'ready') {
        var style = WarmaneFixes.CreateElement('style');
...
WarmaneFixes.UpdateArmoryCharacter = function(event, name, realm, type) {
    switch (type) {
        case 'summary':
            WarmaneFixes.UpdateArmoryCharacterSummary(event, name, realm);
            break;

        case 'match-history':
            WarmaneFixes.UpdateArmoryCharacterMatchHistory(event, name, realm);
            break;

        case 'achievements':
            WarmaneFixes.UpdateArmoryCharacterAchievements(event, name, realm);
            break;

        case 'talents':
            WarmaneFixes.UpdateArmoryCharacterTalents(event, name, realm);
            break;

        case 'statistics':
            WarmaneFixes.UpdateArmoryCharacterStatistics(event, name, realm);
            break;

        case 'mounts-and-companions':
            WarmaneFixes.UpdateArmoryCharacterMountsAndCompanions(event, name, realm);
            break;

        case 'reputation':
            WarmaneFixes.UpdateArmoryCharacterReputation(event, name, realm);
            break;
    }
}

WarmaneFixes.UpdateArmoryCharacterSummary = function (event, name, realm) {
    if (event === 'ready') {
...
WarmaneFixes.UpdateArmoryCharacterMatchHistory = function(event, name, realm) {

}

WarmaneFixes.UpdateArmoryCharacterAchievements = function (event, name, realm) {
    if (event === 'ready') {
        var style = WarmaneFixes.CreateElement('style');
...
WarmaneFixes.UpdateArmoryCharacterTalents = function(event, name, realm) {

}

WarmaneFixes.UpdateArmoryCharacterStatistics = function (event, name, realm) {
    if (event === 'ready') {
        var style = WarmaneFixes.CreateElement('style');
...
WarmaneFixes.UpdateArmoryCharacterMountsAndCompanions = function(event, name, realm) {

}

WarmaneFixes.UpdateArmoryCharacterReputation = function(event, name, realm) {

}

WarmaneFixes.UpdateForum = function(event) {
    if (event === 'ready') {
    ...
    switch (WarmaneFixes.URL.Path) {
        ...
        case '/showthread.php':
            WarmaneFixes.UpdateForumThread(event);
            break;
    }
}

WarmaneFixes.UpdateForumProfile = function(event, name) {
    if (event === 'ready') {
...
WarmaneFixes.UpdateForumThread = function(event) {
    if (event === 'ready') {
...
$(window).on('load', function() {
    WarmaneFixes.Update('load');
});

$(document).ready(function() {
    WarmaneFixes.Update('ready');
});
